<?php
// Text
$_['text_title']				= 'Счет Klarna - Оплатить из %s/месяц';
...
$_['text_information']			= 'Информация по счету Klarna';
...
$_['text_month']				= 'Месяц';
$_['text_day']					= 'День';
$_['text_payment_option']		= 'Параметры оплаты';
$_['text_single_payment']		= 'Единоразовый платеж';
